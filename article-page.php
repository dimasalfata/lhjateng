    ...
    $(document).ready(function () {
        ...
        function load_comment() {
            $.ajax({
                ...
                method: "POST",
                data: {artikel_id: searchParams.get('id')},
                success: function (data) {
    ...
    <div class="content my-3 mb-5">
        ...
        <div class="container mb-3">
            ...
            <form method="POST" id="form_komen">
                <input type="number" name="artikel_id" value="<?php echo $_GET['id'];?>" hidden/>
                <div class="form-group">
                    <input type="text" name="nama_pengirim" id="nama_pengirim" class="form-control"
                           placeholder="Masukkan Nama"/>
                </div>
                <div class="form-group">
                    <textarea name="komen" id="komen" class="form-control" placeholder="Tulis Komentar"
                              rows="5"></textarea>
                </div>
                <div class="form-group">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-5 col-sm-12 footer-content-custom footer-position">
                <div class="col-lg-10">
                    <p>
                        Rumah bagi para komunitas dan organisasi kemahasiswaan yang ada di Jawa tengah untuk bisa
                        berjejaring, belajar, dan bertumbuh
                    </p>
                </div>
            </div>
